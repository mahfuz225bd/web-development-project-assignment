...
<main>
	...
	<!-- #about -->
	<section class="col-1" id="about">
		<h3>About Me</h3>
		<article>
			<h4 style="text-align: center; margin-top: -25px; margin-bottom: -5px">
				Full Stack Developer of handsome experience in designing, developing and
	...
	<section class="col-2 mlr-25">
		<article>
			...
			<div class="skillbar">
				<div class="skills html-css">90%</div>
			</div>
			<p>React</p>
			<div class="skillbar">
		...
		<article>
			...
			<p>Bengali (Native)</p>
			<div class="skillbar">
				<div class="skills bn">95%</div>
			</div>
			<p>English</p>
			<div class="skillbar">
				<div class="skills en">85%</div>
			</div>
			<p>Hindi</p>
			<div class="skillbar">
				<div class="skills hi">70%</div>
			</div>
		</article>
	</section>
		...
		<article>
			<div class="testimonial">
				...
				<div class="container">
					...
					<p>Timely delivery and nice work.</p>
				</div>
				<nav>
			...
			<!-- Testimonial: Show Current Position of the Slide -->
			<style>
